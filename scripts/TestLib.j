library TestLib
    ...
    private function setUpHybrid takes nothing returns nothing
         ...
         set udg_TierOneTowers[2] = 'h03W' // [Demon] - Felguard
         set udg_TierOneTowers[3] = 'hC66' // Tower
         set udg_TierOneTowers[4] = 'hC21' // Ghast
         set udg_TierOneTowers[5] = 'o003' // Chaos Grunt
         set udg_TierOneTowers[6] = 'o009' // [High Elven] - Elven Swordsman
         set udg_TierOneTowers[7] = 'oC14' // Sasquatch
         set udg_TierOneTowers[8] = 'h01C' // Centaur Outrunner
         set udg_TierOneTowers[9] = 'n009' // Corrupted Moon Well
         set udg_TierOneTowers[10] = 'n031' // Angel Warrior
         set udg_TierOneTowers[11] = 'n02T' // Adventurer
         set udg_TierOneTowers[12] = 'n03D' // Forest Troll
         set udg_TierOneTowers[13] = 'n055' // French Soldier
         set udg_TierOneTowers[14] = 'u00C' // [Forsaken] - Tombstone
         ...
         //========== TIER: Two
		 set udg_TierTwoTowers[0] = 'h010' // [Dragons]Dragon Egg
         set udg_TierTwoTowers[1] = 'hC27' // Crypt Fiend
         set udg_TierTwoTowers[2] = 'o004' // Chaos Raider
         set udg_TierTwoTowers[3] = 'oC18' // Gargoyle
         set udg_TierTwoTowers[4] = 'oC19' // [Orc Stronghold] - Headhunter
         set udg_TierTwoTowers[5] = 'o00A' // [High Elven] - High Elf Archer
         set udg_TierTwoTowers[6] = 'oC35' // Ogre Warrior
         set udg_TierTwoTowers[7] = 'n00O' // Corrupted Ent
         set udg_TierTwoTowers[8] = 'n02J' // Gar'thok
         set udg_TierTwoTowers[9] = 'n04L' // Decimator
         set udg_TierTwoTowers[10] = 'n049' // Fallen Archer
         set udg_TierTwoTowers[11] = 'n05I' // Mortar Dwarves
         set udg_TierTwoTowers[12] = 'n02U' // Sorceress
         set udg_TierTwoTowers[13] = 'u00D' // [Forsaken] - Necromancer
         set udg_TierTwoTowers[14] = 'h02I' // Fel Clown
         set udg_TierTwoTowers[15] = 'h020' // [Summons] - Water Elemental
         set udg_TierTwoTowers[16] = 'h04H' // [Draenei] - Salamander Hatchling
         set udg_TierTwoTowers[17] = 'h03U' // [Demon] - Felhound
         set udg_TierTwoTowers[18] = 'oC56' // Meat Wagon
         set udg_TierTwoTowers[19] = 'h01E' // Gnoll Warden
         set udg_TierTwoTowers[20] = 'n056' // Cow Catapult (Sheep)
         set udg_TierTwoTowers[21] = 'n00M' // Den
         ...
         set udg_TierThreeTowers[10] = 'u00E' // [Forsaken] - Abomination
         ...
         set udg_TierFourTowers[9] = 'u00F' // [Forsaken] - Gargoyle Spire
         ...
         set udg_TierFiveTowers[9] = 'u010' // [Forsaken] - Banshee
         ...
         set udg_TierSevenTowers[23] = 'u011' // [Forsaken] - Destroyer
		 ...
		 set udg_TierEightTowers[19] = 'u012' // [Forsaken] - Varimathras
         ...
         set udg_TierNineTowers[11] = 'u013' // [Forsaken] - Sylvanas Windrunner
		 ...
		 set udg_TierNineTowers[25] = 'u01C' // [Outland] - Magtheridon
         set udg_TierNineSize = 25
